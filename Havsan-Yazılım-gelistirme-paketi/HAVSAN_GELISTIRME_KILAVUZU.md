...
│
├── GEMINI.md                     <-- (KİMLİK) "Ben HAVSAN mühendisiyim" diyen anayasa.
│
└── antigravity/
    ├── skills/
    │   └── havsan-development/   <-- (BECERİLER) Proje başlatma, PRD şablonları.
    │       ├── SKILL.md
    │       ├── resources/
    │       └── examples/
    │
    └── workflows/                <-- (İŞ AKIŞLARI) Uzmanlık komutları.
